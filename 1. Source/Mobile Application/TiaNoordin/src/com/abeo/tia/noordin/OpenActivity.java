...
public class OpenActivity extends BaseActivity {
	...
	String CaseList_CaseFileNo_detail = "", CaseList_RelatedFileNo_detail = "", CaseList_BranchCode_detail = "",
			...
			CaseList_Status_detail = "", CaseList_FileClosedDate_detail = "",caseno;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Adapter
		SimpleAdapter simpleAdapter = new SimpleAdapter(OpenActivity.this, myArrayCaseList,
		...
		listView_Property.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				//Toast.makeText(OpenActivity.this, "You Clicked at " + myArrayCaseList.get(position),
				...
				caseno = myArrayCaseList.get(position).get("CaseFileNo_List").toString();
				...
				Intent i = new Intent(OpenActivity.this, ProcessCaseDetails.class);
				startActivity(i);
