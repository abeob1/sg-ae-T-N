...
public class CaseEnqActivity extends BaseActivity {
	// WebService URL =
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Adapter
		SimpleAdapter simpleAdapter = new SimpleAdapter(CaseEnqActivity.this, myArrayCaseList,
		...
		listView_Property.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				//Toast.makeText(CaseEnqActivity.this, "You Clicked at " + myArrayCaseList.get(position),
				...
				Intent i = new Intent(CaseEnqActivity.this, ProcessCaseDetails.class);
				startActivity(i);
