...
public class ActionActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Adapter
		SimpleAdapter simpleAdapter = new SimpleAdapter(ActionActivity.this, myArrayCaseList,
		...
		listView_Property.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				//Toast.makeText(ActionActivity.this, "You Clicked at " + myArrayCaseList.get(position),
				...
				Intent i = new Intent(ActionActivity.this, ProcessCaseDetails.class);
				startActivity(i);
