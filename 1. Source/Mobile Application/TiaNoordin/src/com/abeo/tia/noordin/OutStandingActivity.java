...
public class OutStandingActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Adapter
		SimpleAdapter simpleAdapter = new SimpleAdapter(OutStandingActivity.this, myArrayCaseList,
		...
		listView_Property.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				//Toast.makeText(OutStandingActivity.this, "You Clicked at " + myArrayCaseList.get(position),
				...
				Intent i = new Intent(OutStandingActivity.this, ProcessCaseDetails.class);
				startActivity(i);
